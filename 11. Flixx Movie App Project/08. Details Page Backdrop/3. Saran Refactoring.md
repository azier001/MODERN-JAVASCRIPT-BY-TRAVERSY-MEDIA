...
const TMDB_CONFIG = {
  ...
  IMAGE_ORIGINAL_URL: 'https://image.tmdb.org/t/p/original', // 🆕 BACKDROP
};
...
/* =====================================================
   🖼️ DETAILS PAGE BACKDROP (NEW & CLEAN)
===================================================== */

/**
 * Render backdrop image pada halaman details
 * @param {string} containerSelector
 * @param {string} backdropPath
 */
const renderDetailsBackdrop = (containerSelector, backdropPath) => {
  if (!backdropPath) return; // 🆕 BACKDROP guard clause

  const container = getElement(containerSelector);
  if (!container) return;

  const backdrop = document.createElement('div');
  backdrop.classList.add('details-backdrop'); // 🆕 BACKDROP (CSS class)
...
const CONFIG = {
  ...
  IMAGE_BASE_URL: 'https://image.tmdb.org/t/p/w500',
  BACKDROP_IMAGE_URL: 'https://image.tmdb.org/t/p/original', // 🆕🎬 UNTUK BACKDROP
...
const CSS_CLASSES = {
  ...
  CARD: 'card',
  ACTIVE_LINK: 'active',
  DETAILS_BACKDROP: 'details-backdrop' // 🆕🎬 CLASS UNTUK BACKDROP
};
...
const displayMovieDetails = async () => {
  ...
  // 5. 🆕🎬 Tampilkan backdrop (KODE BARU)
